...
function Clock() {
    ...
    const start = () => {
        let timerId1 = setInterval(newDate, 1000);
        setTimerId(Number(timerId1))
    ...
    let dayFormater = new Intl.DateTimeFormat("en-US", {weekday: 'long'})
    const stringDay = dayFormater.format(date) || <br/> // пишут студенты
    let monthFormater = new Intl.DateTimeFormat("en-US", {month: 'long'})
